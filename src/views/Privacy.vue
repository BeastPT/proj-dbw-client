<template>
    <div class="container mx-auto p-4">
      ...
      <section class="mb-8">
        ...
        <p>A sua privacidade é importante para nós. É política do SkillSwapp respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site SkillSwapp, e outros sites que possuímos e operamos.</p>
      ...
      <section class="mb-8">
        ...
        <ul>
          ...
          <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do SkillSwapp, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
        </ul>
      </section>
  ...
  .container {
    max-width: 800px;
    margin: 20px auto; /* Adicionando margens para o cabeçalho e o rodapé */
  }

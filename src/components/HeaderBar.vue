        ...
        <div class="flex items-center justify-between w-full">
          ...
          <div class="hidden lg:flex items-center justify-end w-full lg:w-auto"> 
            ...
            <template v-if="!loggedIn">
              <button @click="register" type="button" class="ml-6 text-lg lg:text-xl font-semibold text-gray-100 hover:text-gray-400 focus:outline-none focus:text-gray-400">
                Register
              </button>

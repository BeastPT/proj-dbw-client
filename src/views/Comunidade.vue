<template>
    ...
    <div class="ml-48 mr-48 " style="font-family: Arial, sans-serif;">
        ...
        <div class="flex justify-between">
            ...
            <!-- Evento 1 -->
            <div class="event-card flex items-center mb-8">
                <div class="p-14">
                    <h2 class="text-xl font-semibold mb-4">Sessão de Networking</h2>
                    <div class="event-image mx-auto">
                ...
                <div class="p-4 pt-16">
                    ...
                    <div class="pt-8">
                        <button class="w-48 h-10 bg-gray-800 rounded-full text-white text-sm">Brevemente</button>
                    </div>
                </div>
            </div>

            <!-- Evento 2 -->
            <div class="event-card flex items-center mb ml-auto">
                <div class="p-14">
                ...
                <div class="p-4 pt-16">
                    ...
                    <div class="pt-8">
                        <button class="w-48 h-10 bg-gray-800 rounded-full text-white text-sm">Inscreva-se</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class='flex items-center justify-center mt-8 mb-64'>
            <ul class="mx-auto grid max-w-full w-full grid-cols-3 gap-x-5 px-8">
                <li class="">
                    ...
                    <div class="absolute bg-white shadow-2xl left-48 p-6 border mt-5  rounded-lg right-48 max-h-[40vh] mx-auto transition-all duration-500 ease-in-out translate-x-40 opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-x-1 overflow-auto">

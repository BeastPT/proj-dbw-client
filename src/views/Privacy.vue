  ...
  <!-- Todo o texto de Politica e privacidade formalizado -->
    <section class="mb-8">
      ...
      <p>A sua privacidade é importante para nós. É política do SkillSwapp respeitar a sua privacidade em relação a
        qualquer informação sua que possamos coletar no site SkillSwapp, e outros sites que possuímos e operamos.</p>
    ...
    <section class="mb-8">
      ...
      <p>O serviço Google AdSense que usamos para veicular publicidade usa um cookie DoubleClick para veicular anúncios
        mais relevantes em toda a Web e limitar o número de vezes que um determinado anúncio é exibido para você. Para
        mais informações sobre o Google AdSense, consulte as FAQs oficiais sobre privacidade do Google AdSense.
        ...
        apresentando coisas semelhantes que possam ser do seu interesse. Vários parceiros anunciam em nosso nome e os
        cookies de rastreamento de afiliados simplesmente nos permitem ver se nossos clientes acessaram o site através
        de um dos sites de nossos parceiros, para que possamos creditá-los adequadamente e, quando aplicável, permitir
        que nossos parceiros afiliados ofereçam qualquer promoção que possa fornecer para fazer uma compra.</p>
    </section>

    <section class="mb-8">
      <h2 class="text-2xl font-semibold mb-4">Compromisso do Utilizador</h2>
      <p>O utilizador compromete-se a fazer o uso adequado dos conteúdos e da informação que o SkillSwapp oferece no
      ...
      <ul>
        ...
        <li>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, Bet Nacional ou azar, qualquer tipo de
          pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do SkillSwapp, de seus fornecedores
    ...
    <section>
      <h2 class="text-2xl font-semibold mb-4">Mais Informações</h2>
      <p> Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se
        ...
        usa em nosso site.</p>
      <p>Esta política é efetiva a partir de 12 de maio de 2024 às 22:51.</p>
    </section>
  </div>
</template>
...
.container {
  max-width: 800px;
  margin: 20px auto;
  /* Adicionando margens para o cabeçalho e o rodapé */
}

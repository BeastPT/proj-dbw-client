...
<div class="px-4 md:px-8 lg:px-16 xl:px-32 py-8 font-sans">
        ...
        <div class="flex flex-col md:flex-row md:justify-between mb-8">
            <!-- Evento 1 -->
            <div class="event-card flex flex-col md:flex-row items-center  self-center mb-8">
                <div class="p-14">
            ...
            <!-- Evento 2 -->
            <div class="event-card flex flex-col md:flex-row items-center mb-8">
                <div class="p-14">
        ...
        <div class='flex items-center justify-center mt-8 mb-64'>
            <ul class="mx-auto grid max-w-full md:w-full grid-cols-3 gap-x-5 px-8 sm:px-2">
                <li class="">
                    ...
                    <label class="flex justify-center cursor-pointer rounded-full border border-gray-300 bg-white py-2 px-4 hover:bg-gray-50 focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-blue-600 transition-all duration-500 ease-in-out" for="yes">Sobre</label>
        
                    <div class="absolute bg-white shadow-2xl p-6 border rounded-lg max-h-[40vh] mx-8 mt-5 sm:mx-auto sm:mt-8 left-0 sm:left-auto md:left-48 md:right-48 transition-all duration-500 ease-in-out opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-x-1 overflow-auto">
                ...
                <li class="">
                    ...
                    <label class="flex justify-center cursor-pointer rounded-full border border-gray-300 bg-white py-2 px-4 hover:bg-gray-50 focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-blue-600 transition-all duration-500 ease-in-out" for="no">Objetivos</label>
                    ...
                    <div class="absolute bg-white shadow-2xl p-6 border rounded-lg max-h-[40vh] mx-8 mt-5 sm:mx-auto sm:mt-8 left-0 sm:left-auto md:left-48 md:right-48 transition-all duration-500 ease-in-out opacity-0 invisible peer-checked:opacity-100 peer-checked:visible peer-checked:translate-x-1 overflow-auto">
                        ...
                        Inovação: Promover a inovação e a criatividade, permitindo que as empresas explorem novas formas de realização de projetos com a ajuda de tecnologias avançadas.
                    </div>
                </li>
        
                <li class="">
                    <input class="peer sr-only" type="radio" value="yesno" name="answer" id="yesno" />
                    <label class="flex justify-center cursor-pointer rounded-full border border-gray-300 bg-white py-2 px-4 hover:bg-gray-50 focus:outline-none peer-checked:border-transparent peer-checked:ring-2 peer-checked:ring-blue-600 transition-all duration-500 ease-in-out " for="yesno">Futuro</label>
...
.event-card {
    width:  100%;
    min-height: 350px; /* Garante que todos os cartões tenham a mesma altura */
...
.event-image{
    max-width: 300px; /* Defina o tamanho da largura que deseja para a imagem */
    height: 200px; /* Defina o tamanho da altura que deseja para a imagem */
    border-radius: 5px;
...
@media (min-width: 768px) {
    .event-card {
        width: 48%; /* 2 cartões por linha em telas grandes */
    }
}
